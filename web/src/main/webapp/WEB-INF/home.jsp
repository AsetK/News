...
<body ng-app="myApp">
    <a href="/?siteLanguage=en">English</a>|<a href="/?siteLanguage=ru">Русский</a><br><br>

    <a href="#newsmanagement"><spring:message code="label.newsManagement"/> </a>
    ...
    <script>
        ...
        app.controller('editnews', function($scope, $http, $routeParams) {
            ...
            $scope.save = function() {
                ...
                $http.post('savechanges',Json_news).then(
                    function (response) {
                        $scope.msg2 = "News is edited";
                    },
